...
{
    public partial class PCRemoteDB : IQuerySurface
    {
        ...
        public PCRemoteDB() 
        { 
            DataProvider = ProviderFactory.GetProvider("PCRemoteDB");
            Init();
        }

        public PCRemoteDB(string connectionStringName)
        {
            DataProvider = ProviderFactory.GetProvider(connectionStringName);
            Init();
        }

		public PCRemoteDB(string connectionString, string providerName)
        {
        ...
        public Query<sqlite_sequence> sqlite_sequences { get; set; }
        public Query<Command> Commands { get; set; }
        ...
        void Init()
        {
            ...
            Commands = new Query<Command>(provider);
            #endregion
        	...
        	if(DataProvider.Schema.Tables.Count == 0)
			{
            	...
            	DataProvider.Schema.Tables.Add(new CommandsTable(DataProvider));
            }
            #endregion
        }
    }
